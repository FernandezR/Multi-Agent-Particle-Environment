...
class World(object):
    ...
    def step(self):
        ...
        synchronized_predator_prey_scenario = self.synchronized_predator_prey if hasattr(self, 'synchronized_predator_prey') else False
        if not synchronized_predator_prey_scenario:
