...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, arglist, logger, reset_callback=None, reward_callback=None, observation_callback=None,
        ...
        self.synchronized_predator_prey_scenario = self.world.synchronized_predator_prey if hasattr(self.world, 'synchronized_predator_prey') else False
        ...
        for agent in self.agents:
            ...
            # Observation space
            if not self.synchronized_predator_prey_scenario and not self.turret_cg_scenario:
